  ...
  return (
    <nav className="navbar">
            <div className="navbar-logo">
                <svg className="navbar-svg-primary" viewBox="0 0 55 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="navbar-svg-secondary" viewBox="0 0 47 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="navbar-svg-secondary" viewBox="0 0 41 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg  className="navbar-svg-secondary" viewBox="0 0 42 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className="navbar-link">
                ...
                <li className="navbar-link-item"> 
                    <Link to="/location">A propos</Link>
                </li>
            </ul>
    </nav>
  );
